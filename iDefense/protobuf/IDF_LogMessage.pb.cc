...
void protobuf_AssignDesc_IDF_5fLogMessage_2eproto() {
  protobuf_AddDesc_IDF_5fLogMessage_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "IDF_LogMessage.proto");
  GOOGLE_CHECK(file != NULL);
  LogMessage_descriptor_ = file->message_type(0);
  static const int LogMessage_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LogMessage, debug_level_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LogMessage, max_size_),
  };
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_IDF_5fLogMessage_2eproto);
}
...
void protobuf_AddDesc_IDF_5fLogMessage_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\024IDF_LogMessage.proto\022\003idf\"\?\n\nLogMessag"
    "e\022\026\n\013debug_level\030\001 \002(\005:\0013\022\031\n\010max_size\030\002 "
    "\002(\005:\0074194304", 92);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "IDF_LogMessage.proto", &protobuf_RegisterTypes);
  LogMessage::default_instance_ = new LogMessage();
  LogMessage::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_IDF_5fLogMessage_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_IDF_5fLogMessage_2eproto {
  StaticDescriptorInitializer_IDF_5fLogMessage_2eproto() {
    protobuf_AddDesc_IDF_5fLogMessage_2eproto();
  }
} static_descriptor_initializer_IDF_5fLogMessage_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int LogMessage::kDebugLevelFieldNumber;
const int LogMessage::kMaxSizeFieldNumber;
#endif  // !_MSC_VER

LogMessage::LogMessage()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:idf.LogMessage)
}
...
LogMessage::LogMessage(const LogMessage& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:idf.LogMessage)
}
...
LogMessage::~LogMessage() {
  // @@protoc_insertion_point(destructor:idf.LogMessage)
  SharedDtor();
}
...
const LogMessage& LogMessage::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_IDF_5fLogMessage_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:idf.LogMessage)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:idf.LogMessage)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:idf.LogMessage)
  return false;
#undef DO_
}
...
void LogMessage::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:idf.LogMessage)
  // required int32 debug_level = 1 [default = 3];
  if (has_debug_level()) {
  ...
  // @@protoc_insertion_point(serialize_end:idf.LogMessage)
}

::google::protobuf::uint8* LogMessage::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:idf.LogMessage)
  // required int32 debug_level = 1 [default = 3];
  if (has_debug_level()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:idf.LogMessage)
  return target;
}
